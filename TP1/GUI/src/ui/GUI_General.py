...
class GUI_Base(object):
    def setupUi(self, Form):
        ...
        self.InputFrame.setStyleSheet("QGroupBox#InputFrame { border: 0.5px solid black; font-weight: bold}")
        ...
        self.horizontalLayout = QtWidgets.QVBoxLayout(self.AmplitudFrame)
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.AmpLabel = QtWidgets.QLabel(self.AmplitudFrame)
        self.AmpLabel.setAlignment(QtCore.Qt.AlignHCenter)
        self.AmpLabel.setObjectName("AmpLabel")
        self.horizontalLayout.addWidget(self.AmpLabel, 0)
        self.AmpSignal = QtWidgets.QDoubleSpinBox(self.AmplitudFrame)
        self.AmpSignal.setMinimum(1)
        self.AmpSignal.setMaximum(5000)
        self.AmpSignal.setObjectName("AmpSignal")
        self.AmpSignal.setAlignment(QtCore.Qt.AlignHCenter)
        self.horizontalLayout.addWidget(self.AmpSignal, alignment = QtCore.Qt.AlignHCenter)
        self.AmpUnit = QtWidgets.QLabel(self.AmplitudFrame)
        self.AmpUnit.setObjectName("AmpUnit")
        self.horizontalLayout.addWidget(self.AmpUnit, alignment = QtCore.Qt.AlignHCenter)
        self.verticalLayout_4.addWidget(self.AmplitudFrame, alignment = QtCore.Qt.AlignHCenter)
        self.FreqFrame = QtWidgets.QFrame(self.ParameterSignalFrame)
        self.FreqFrame.setObjectName("FreqFrame")
        self.horizontalLayout_3 = QtWidgets.QVBoxLayout(self.FreqFrame)
        self.horizontalLayout_3.setObjectName("horizontalLayout_3")
        self.FreqLabel = QtWidgets.QLabel(self.FreqFrame)
        self.FreqLabel.setAlignment(QtCore.Qt.AlignHCenter)
        self.FreqLabel.setObjectName("FreqLabel")
        self.horizontalLayout_3.addWidget(self.FreqLabel, 0)
        self.FreqSignal = QtWidgets.QDoubleSpinBox(self.FreqFrame)
        self.FreqSignal.setMinimum(.01)
        self.FreqSignal.setMaximum(1000)
        self.FreqSignal.setSingleStep(.01)
        self.FreqSignal.setObjectName("FreqSignal")
        self.FreqSignal.setAlignment(QtCore.Qt.AlignHCenter)
        self.horizontalLayout_3.addWidget(self.FreqSignal, alignment = QtCore.Qt.AlignHCenter)
        self.FreqUnit = QtWidgets.QLabel(self.FreqFrame)
        self.FreqUnit.setObjectName("FreqUnit")
        self.horizontalLayout_3.addWidget(self.FreqUnit, alignment = QtCore.Qt.AlignHCenter)
        self.verticalLayout_4.addWidget(self.FreqFrame, alignment = QtCore.Qt.AlignHCenter)
        ...
        self.SampleFrame.setStyleSheet("QGroupBox#SampleFrame { border: 0.5px solid black; font-weight: bold}")
        ...
        self.horizontalLayout_4 = QtWidgets.QVBoxLayout(self.DutyFrame)
        self.horizontalLayout_4.setObjectName("horizontalLayout_4")
        self.DutyLabel = QtWidgets.QLabel(self.DutyFrame)
        self.DutyLabel.setAlignment(QtCore.Qt.AlignHCenter)
        self.DutyLabel.setObjectName("DutyLabel")
        self.horizontalLayout_4.addWidget(self.DutyLabel)
        self.DutySample = QtWidgets.QSpinBox(self.DutyFrame)
        self.DutySample.setAlignment(QtCore.Qt.AlignHCenter)
        self.DutySample.setMinimum(5)
        self.DutySample.setMaximum(100)
        ...
        self.DutyUnit.setAlignment(QtCore.Qt.AlignHCenter)
        self.horizontalLayout_4.addWidget(self.DutyUnit)
        self.SampleLayout.addWidget(self.DutyFrame, alignment = QtCore.Qt.AlignHCenter)
        ...
        self.horizontalLayout_5 = QtWidgets.QVBoxLayout(self.FreqSampleFrame)
        self.horizontalLayout_5.setObjectName("horizontalLayout_5")
        self.SampFreqLabel = QtWidgets.QLabel(self.FreqSampleFrame)
        self.SampFreqLabel.setAlignment(QtCore.Qt.AlignHCenter)
        ...
        self.SampFreqUnit.setAlignment(QtCore.Qt.AlignHCenter)
        self.SampFreqUnit.setObjectName("SampFreqUnit")
        self.horizontalLayout_5.addWidget(self.SampFreqUnit)
        self.SampleLayout.addWidget(self.FreqSampleFrame, alignment = QtCore.Qt.AlignHCenter)
        ...
        self.GeneralSelectionFrame.setTitle('General')
        ...
        self.GeneralSelectionFrame.setStyleSheet("QGroupBox#GeneralSelectionFrame { border: 0.5px solid black; font-weight: bold}")
        ...
        self.ClearButton = QtWidgets.QPushButton('Clear Plots', parent = self.PlotFrame)
        ...
        self.GeneralSelectionLayout.addWidget(self.Exit, alignment = QtCore.Qt.AlignRight)
    ...
    def retranslateUi(self, Form):
        ...
        self.SignalSelection.setItemText(0, _translate("Form", "Cosine"))
        self.SignalSelection.setItemText(1, _translate("Form", "Sine"))
        self.SignalSelection.setItemText(2, _translate("Form", "Exponential"))
        self.SignalSelection.setItemText(3, _translate("Form", "AM"))
        self.SignalLabel.setText(_translate("Form", '   A * cos(2π * f * t) ; [0, 2π]    '))
        self.SignalSelection.lineEdit().setAlignment(QtCore.Qt.AlignHCenter)
        self.SignalLabel.setAlignment(QtCore.Qt.AlignHCenter)
        self.AmpLabel.setText(_translate("Form", "A"))
        self.AmpUnit.setText(_translate("Form", "mV "))
        self.FreqLabel.setText(_translate("Form", "f"))
        self.FreqUnit.setText(_translate("Form", "kHz"))
        ...
        self.SampFreqUnit.setText(_translate("Form", "kHz"))
