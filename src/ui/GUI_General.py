...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.InputFrame = QtWidgets.QFrame(self.FatherFrame)
        ...
        self.GeneralSelectionFrame = QtWidgets.QFrame(self.FatherFrame)
    ...
    def retranslateUi(self, Form):
        ...
        self.SignalLabel.setText(_translate("Form", "Text"))
        ...
        self.AnalogKayLabel.setText(_translate("Form", "Analog Key"))
